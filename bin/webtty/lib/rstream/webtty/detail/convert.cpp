...
static void convert(protocol::environment& dst, const rstream::webtty::protobuf::Environment& src);

static void convert(rstream::webtty::protobuf::Environment& dst, const protocol::environment& src);

static void convert(protocol::identifier& dst, const rstream::webtty::protobuf::Username& src);

static void convert(rstream::webtty::protobuf::Username& dst, const protocol::identifier& src);
...
void convert(rstream::webtty::protobuf::Environment& dst, const protocol::environment& src)
{
  dst.set_key(src.m_key);
  dst.set_value(src.m_value);
}

void convert(protocol::identifier& dst, const rstream::webtty::protobuf::Username& src)
{
  auto type = src.payload_case();
  if (type == rstream::webtty::protobuf::Username::PayloadCase::kName) {
    dst = src.name();
  }
  else if (type == rstream::webtty::protobuf::Username::PayloadCase::kId) {
    dst = src.id();
  }
}

void convert(rstream::webtty::protobuf::Username& dst, const protocol::identifier& src)
{
