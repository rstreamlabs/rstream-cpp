...
resolver_ptr element_impl<T>::resolver(const executor_type& executor, const endpoint_base::protocol_type::value_type& protocol) const
{
  ...
  auto ptr        = make_object_ptr<resolver_ptr(const executor_type&, const endpoint_base::protocol_type::value_type&, element_const_ptr), typename T::resolver>()(executor, protocol, parent_ptr);
...
{
  auto parent_ptr = std::enable_shared_from_this<element_impl>::shared_from_this();
  auto ptr        = make_object_ptr<stream_socket_ptr(const executor_type&, const endpoint_base::protocol_type::value_type&, element_const_ptr), typename T::stream_socket>()(executor, protocol, parent_ptr);
...
{
  auto parent_ptr = std::enable_shared_from_this<element_impl>::shared_from_this();
  auto ptr        = make_object_ptr<acceptor_ptr(const executor_type&, const endpoint_base::protocol_type::value_type&, element_const_ptr), typename T::acceptor>()(executor, protocol, parent_ptr);
